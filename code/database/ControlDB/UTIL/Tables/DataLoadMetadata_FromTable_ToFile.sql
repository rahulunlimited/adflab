CREATE TABLE [UTIL].[DataLoadMetadata_FromTable_ToFile] (
    [RecordID]                  UNIQUEIDENTIFIER CONSTRAINT [Util_DataLoadMetadata_FromFile_ToFile_DF_RecordID] DEFAULT (newid()) NOT NULL,
    ...
    CONSTRAINT [PK_DataLoadMetadata_FromTable_ToFile] PRIMARY KEY ([RecordID])
);
